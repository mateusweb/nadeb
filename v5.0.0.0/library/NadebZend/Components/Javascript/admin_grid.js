...
$('tbody a').live('mouseout', function(){
	var title = $('#nadebTips').text();
	$(this).attr('title', title);
	$('#nadebTips').remove();
	clearTimeout( nadebTips );
});

$('tbody a').live('mouseover', function(){
	...
	if( title )
	{
		...
		var tip;
		tip = '<div id="nadebTips"><p id="nadebTipsBg">' + title + '</p></div>';
		$(this).after( tip );
		$('#nadebTips').hide();
		nadebTips = setTimeout(function(){
			$('#nadebTips').fadeTo(500,.9);
		},1500)
	}
