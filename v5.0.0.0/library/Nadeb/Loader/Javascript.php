 ...
 * Retorna como string um Javascript carregado de um arquivo
 * 
 * @category   Nadeb
 * @package    Nadeb_Loader_Javascript
 * @copyright  Copyright 2010 mateusweb.com.br
 * @license    http://www.gnu.org/licenses/gpl.html | GPL
 */
class Nadeb_Loader_Javascript
{
	/**
	 * 
	 * @var string
	...
	{
		$file   = $_SERVER['DOCUMENT_ROOT'] . __ROOT__ . $this->patch . $_file . ".js";
